...
SCENARIOS=(
  ...
  "grep-tree|Results grouped by file in Trouble|14|Snacks|Space|sg|validateToken|wait:6:C-t"
  ...
  "explorer-search-deep|A filter matching inside nested directories, shown in place|14|openspec|wait:2:Space|wait:3:e|i|wait:3:spec"
  ...
  "lsp-workspace-symbols|Workspace symbols|16|Lsp Workspace Symbols|Space|ff|lib.lua|Enter|wait:4:Space|wait:4:sS"
